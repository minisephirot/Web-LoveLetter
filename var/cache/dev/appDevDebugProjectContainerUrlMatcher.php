...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'LoveBundle_ultrahome');
            }

            return array (  '_controller' => 'EJ\\LoveBundle\\Controller\\GameController::toindexAction',  '_route' => 'LoveBundle_ultrahome',);
        }
